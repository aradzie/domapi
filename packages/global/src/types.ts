...
declare namespace CSS {
  ...
  export function supports(conditionText: string): boolean;
}
...
export type CanvasImageSource =
  ...
  | HTMLCanvasElement
  | ImageBitmap;
export type ClipboardItemData = Promise<string | Blob>;
...
export type OnBeforeUnloadEventHandler =
...
export type CompositeOperationOrAuto =
  | "accumulate"
  | "add"
  | "auto"
  | "replace";
...
export type DisplayCaptureSurfaceType = "browser" | "monitor" | "window";
...
export type MediaKeyMessageType =
  ...
  | "license-renewal"
  | "license-request";
export type MediaKeySessionClosedReason =
...
export type NavigationTimingType =
  | "back_forward"
  | "navigate"
  | "prerender"
  | "reload";
...
export type PlaybackDirection =
  ...
  | "normal"
  | "reverse";
export type PositionAlignSetting =
  | "auto"
  | "center"
  | "line-left"
  | "line-right";
...
export type RTCDegradationPreference =
  | "balanced"
  | "maintain-framerate"
  | "maintain-resolution";
export type RTCDtlsTransportState =
  ...
  | "failed"
  | "new";
export type RTCEncodedVideoFrameType = "delta" | "empty" | "key";
...
export type UserVerificationRequirement =
  ...
  | "preferred"
  | "required";
export type VideoColorPrimaries = "bt470bg" | "bt709" | "smpte170m";
export type VideoFacingModeEnum = "environment" | "left" | "right" | "user";
export type VideoMatrixCoefficients = "bt470bg" | "bt709" | "rgb" | "smpte170m";
